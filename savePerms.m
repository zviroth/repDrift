...
function res = savePerms(rois,toZscore,nperms,r2thresh,fixedFirst)
...
if ieNotDefined('nperms'), nperms = 1000; end%1=GLMdenoise, 2=without GLMdenoise, i.e. betas2.
if ieNotDefined('r2thresh'), r2thresh = 0; end%1=GLMdenoise, 2=without GLMdenoise, i.e. betas2.
if ieNotDefined('fixedFirst'), fixedFirst = 0; end%1=GLMdenoise, 2=without GLMdenoise, i.e. betas2.
...
if ~isfolder(saveFolder)
    saveFolder = ['/misc/data18/rothzn/nsd/repDrift' versionStr '/'];
end
