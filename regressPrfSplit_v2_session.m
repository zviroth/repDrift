...
function res = regressPrfSplit_v2_session(isub,visualRegions,toZscore,noBackground)
...
%VERSION 2: nsd betas ver2
saveFolder = ['/misc/data18/rothzn/nsd2/repDrift/'];
betasfolder = ['/misc/data18/rothzn/nsd2/sub' num2str(isub) '_betas_func1pt8mm/'];
