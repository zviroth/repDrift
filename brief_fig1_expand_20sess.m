...
load(fullfile(saveFolder, ['perm_20sess' fixedFirstStr num2str(nperms) zscoreStr normalizeStr r2threshStr '.mat']),...
...
if saveFigs
    if ~addColorbars
        savepdf(f,fullfile(figsFolder,['brief_fig1_20sess' fixedFirstStr zscoreStr '.pdf']));
    else
        savepdf(f,fullfile(figsFolder,['brief_fig1_20sess' fixedFirstStr zscoreStr '_colorbar.pdf']));
    end
end
